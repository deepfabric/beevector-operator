...
const (
	...
	LastAppliedConfigAnnotation = "infinivision.com/last-applied-configuration"
...
func storePodName(cName string, ordinal int32) string {
	return fmt.Sprintf("%s-%d", controller.StoreMemberName(cName), ordinal)
}

func prophetPodName(cName string, ordinal int32) string {
	return fmt.Sprintf("%s-%d", controller.ProphetMemberName(cName), ordinal)
}
