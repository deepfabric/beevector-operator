...
const (
	...
	// For resources managed by Hyena Operator, its value is always hyena-operator
	...
	// It should always be hyena-cluster in our case.
	...
	ClusterIDLabelKey string = "hyena.infinivision.com/cluster-id"
	// StoreIDLabelKey is store id label key
	StoreIDLabelKey string = "hyena.infinivision.com/store-id"
	// MemberIDLabelKey is member id label key
	MemberIDLabelKey string = "hyena.infinivision.com/member-id"
	// AnnPodNameKey is pod name annotation key used in PV/PVC for synchronizing hyena cluster meta info
	AnnPodNameKey string = "hyena.infinivision.com/pod-name"
	// AnnPVCDeferDeleting is pvc defer deletion annotation key used in PVC for defer deleting PVC
	AnnPVCDeferDeleting = "hyena.infinivision.com/pvc-defer-deleting"
	// AnnPVCPodScheduling is pod scheduling annotation key, it represents whether the pod is scheduling
	AnnPVCPodScheduling = "hyena.infinivision.com/pod-scheduling"

	// ProphetLabelVal is Prophet label value
	ProphetLabelVal string = "prophet"
...
// Prophet assigns prophet to component key in label
func (l Label) Prophet() Label {
	l.Component(ProphetLabelVal)
	return l
}

// IsProphet returns whether label is a Prophet
func (l Label) IsProphet() bool {
	return l[ComponentLabelKey] == ProphetLabelVal
}
