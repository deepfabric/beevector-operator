...
func TestPVCControlUpdateMetaInfoSuccess(t *testing.T) {
	...
	updatePVC, err := control.UpdateMetaInfo(hc, pvc, pod)
...
func TestPVCControlUpdateMetaInfoFailed(t *testing.T) {
	...
	_, err := control.UpdateMetaInfo(hc, pvc, pod)
...
func TestPVCControlUpdatePVCSuccess(t *testing.T) {
	...
	updatePVC, err := control.UpdatePVC(hc, pvc)
	g.Expect(err).To(Succeed())
...
func TestPVCControlUpdatePVCFailed(t *testing.T) {
	...
	_, err := control.UpdatePVC(hc, pvc)
	g.Expect(err).To(HaveOccurred())
...
func newPVC(hc *v1alpha1.HyenaCluster) *corev1.PersistentVolumeClaim {
